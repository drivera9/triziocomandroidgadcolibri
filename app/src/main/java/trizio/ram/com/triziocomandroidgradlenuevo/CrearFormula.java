...
public class CrearFormula extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Lista_entrada_panel> datos = new ArrayList<>();

        for (int i = 0;i<atributos.size();i++){
            datos.add(new Lista_entrada_panel(R.drawable.close, atributos.get(i).trim() , "",0));
        }
            ...
            public void onEntrada(Object entrada, View view) {
                if (entrada != null) {
                    ...
                    if (texto_superior_debajo != null)
                        texto_superior_debajo.setText(((Lista_entrada_panel) entrada).get_textoDebajo());
