        ...
        protected String doInBackground(String... f_url) {
            ...
            if (num_grupo.trim().equals("")){
                for (int i = 0;i<atributos.size();i= i+2){
                    String url = "http://" + ip + "/guardarMovimientoColibri.php";
                ...
                String url3 = "http://" + ip + "/guardarMovimientoColibri.php";
                ...
                try {
                    ...
                    String url2 = "http://" + ip + "/guardarMovimientoColibri.php";
        ...
        protected String doInBackground(String... f_url) {
            ...
            if (!conexion.equals("local")) {
                ...
                if (cod_proceso.trim().equals("57")) {
                    ...
                    String url10 = "http://" + ip + "/consultarGeneralColibri.php";
                ...
                url = "http://" + ip + "/guardarMovimientoColibri.php";
                List<NameValuePair> params = new ArrayList<NameValuePair>();
                ...
                url1 = "http://" + ip + "/consultarGeneralColibri.php";
                ...
                try {
                    ...
                    url2 = "http://" + ip + "/guardarMovimientoColibri.php";
            ...
            if (!conexion.trim().equals("local")) {
                ...
                if (cod_proceso.trim().equals("58")){
                    ...
                    if (cod_proceso.trim().equals("57")){
                        ...
                        String url32 = "http://" + ip + "/guardarMovimientoColibri.php";
