...
public class Guardar extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // guardar.setVisibility(View.INVISIBLE);
        ...
        if (descripcionModelo.trim().equals("")) {
            ...
            String url4 = "http://" + ip + "/consultarGeneral2Gad.php";
            ...
            String url = "http://" + ip + "/consultarGeneral2Gad.php";
        ...
        /*String url = "http://" + ip + "/atributosGad.php";
    ...
    class GuardarMovimiento extends AsyncTask<String, String, String> {
        ...
        /*String url4 = "http://" + ip + "/consultarPlacaGad.php";
        List<NameValuePair> params4 = new ArrayList<NameValuePair>();
        ArrayList<String> array = new ArrayList<String>();
        String resultServer4 = getHttpPost(url4, params4);
        try {
...
*/
        ...
        /*for (int i = 0;i<rutas.size();i++) {
            //showProgress(true);
            String url3 = "http://" + ip + "/desactivarRomUbicGad.php";
            ...
            String url2 = "http://" + ip + "/guardarMovimientoGad.php";
            ...
            String url1 = "http://" + ip + "/actualizarCitaGad.php";
       ...
       /* String url3 = "http://" + ip + "/consultarGeneralGad.php";
        ...
        try {
            ...
            try {
                ...
                guardarMovimiento();
            /*String url2 = "http://" + ip + "/aumentarConsecutivoGad.php";
            List<NameValuePair> params2 = new ArrayList<NameValuePair>();
            String resultServer2 = getHttpPost(url2, params2);
            System.out.println(resultServer2);
            try {
    ...
    class GuardarEncabezado extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            sql+= "convert(datetime,'" + promesa + "',120)" ;
            sql+= ");";
            ...
            if (consecutivo) {
                ...
                try {
                    ...
                    if (cod_proceso.trim().equals("23") || cod_proceso.trim().equals("1")) {

                        url3 = "http://" + ip + "/guardarMovimientoGad.php";
                        ...
                        url6 = "http://" + ip + "/consultarGeneralGad.php";
                    ...
                    try {
                        ...
                        String url5 = "http://" + ip + "/guardarMovimientoGad.php";
...
*/
       ...
       /* String url3 = "http://" + ip + "/consultarGeneralGad.php";
        ...
        /*String url2 = "http://192.168.1.190:8080/guardarPruebaGad.php";
