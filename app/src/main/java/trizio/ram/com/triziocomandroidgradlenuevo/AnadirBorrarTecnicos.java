...
public class AnadirBorrarTecnicos extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anadir_borrar_tecnicos);
    ...
    public void añadir(View v){
        ...
        if (tecnico.getText().toString().trim().equals("")){
            Toast.makeText(getApplicationContext(), "Por favor digite el tecnico !", Toast.LENGTH_SHORT).show();
        }else{

            AlertDialog.Builder builder1 = new AlertDialog.Builder(AnadirBorrarTecnicos.this);
            builder1.setMessage("Esta seguro que desea añadir el tecnico?");
            ...
            builder1.setPositiveButton(
                    ...
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            params.add(new BasicNameValuePair("sParametro", "anadirTecnico"));

                            String resultServer7 = getHttpPost(url, params);
                            System.out.println(resultServer7);

                            Toast.makeText(getApplicationContext(), "Haz añadido el tecnico correctamente!", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
    ...
    public void borrar(View v){
        ...
        if (tecnico.getText().toString().trim().equals("")){
            ...
            AlertDialog.Builder builder1 = new AlertDialog.Builder(AnadirBorrarTecnicos.this);
            builder1.setMessage("Esta seguro que desea borrar el tecnico?");
            builder1.setCancelable(true);
            ...
            builder1.setPositiveButton(
                    ...
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            params.add(new BasicNameValuePair("sCodSucursal", sucursal));
                            params.add(new BasicNameValuePair("sValRecurso", tecnico.getText().toString().trim()));
                            params.add(new BasicNameValuePair("sParametro", "borrarTecnico"));

                            String resultServer7 = getHttpPost(url, params);
                            System.out.println(resultServer7);

                            Toast.makeText(getApplicationContext(), "Haz borrado el tecnico correctamente!", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
    ...
    public void ver(View v){
        Intent intent = new Intent((Context) AnadirBorrarTecnicos.this, (Class) MostrarRombUbic.class);
