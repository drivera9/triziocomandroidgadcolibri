...
public class MostrarCliente extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            String nombre1 = bundle.getString("nombre1").replace("\u0000", "");
            String nombre2 = bundle.getString("nombre2").replace("\u0000", "");
            String apellido1 = bundle.getString("apellido1").replace("\u0000", "");
            String apellido2 = bundle.getString("apellido2").replace("\u0000", "");

            nombres = nombre1.trim() + " " + nombre2.trim() + " " + apellido1 + " " + apellido2;
    ...
    class GuardarMovimiento extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            url = "http://" + ip + "/consultarGeneralGad.php";
