                ...
                public void onClick(View arg0) {
                    ...
                    for (int i = 0;i<procesos.size();i++){
                        ...
                        try {
                            ...
                            if (procesos.get(i).trim().equals("30")) {
                                datos.add(new Lista_entrada(R.drawable.recepcion, "   " + nomProceso.get(i)));
                                continue;
                            }
                        }catch(Exception e){
                    ...
                    lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> pariente, View view, int posicion, long id) {
                            ...
                            if (elegido.get_textoEncima().trim().equals("RECEPCION INMEDIATA")) {
                                Intent intent = new Intent((Context) Procesos.this, (Class) RecepcionInmediata.class);
                                Bundle bundle2 = new Bundle();
                                bundle2.putString("user", user);
                                bundle2.putString("pass", pass);
                                bundle2.putString("sucursal", sucursal);
                            ...
                            if (elegido.get_textoEncima().trim().equals("ADMINISTRAR TECNICOS")) {
                                Intent intent = new Intent((Context) Procesos.this, (Class) AnadirBorrarTecnicos.class);
                                Bundle bundle2 = new Bundle();
                                bundle2.putString("user", user);
                                bundle2.putString("pass", pass);
                                bundle2.putString("sucursal", sucursal);
                                ...
                                bundle2.putString("sucursal", sucursal);
                                bundle2.putString("ip", ip);
                                bundle2.putString("titulo", titulo + "/Tec");
                            ...
                            if (elegido.get_textoEncima().trim().equals("ADMINISTRAR RAZONES")) {
                                Intent intent = new Intent((Context) Procesos.this, (Class) AnadirBorrarRazones.class);
                                Bundle bundle2 = new Bundle();
                                bundle2.putString("user", user);
                                bundle2.putString("pass", pass);
                                bundle2.putString("sucursal", sucursal);
                            ...
                            if (elegido.get_textoEncima().trim().equals("ADMINISTRAR VEHICULOS")) {
                                Intent intent = new Intent((Context) Procesos.this, (Class) AnadirBorrarVehiculosOpciones.class);
                                Bundle bundle2 = new Bundle();
                                bundle2.putString("user", user);
                                bundle2.putString("pass", pass);
                                bundle2.putString("sucursal", sucursal);
